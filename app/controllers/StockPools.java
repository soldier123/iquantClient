...
public class StockPools extends BasePlayControllerSupport {
    ...
    public static void test() {
        StockPoolBasicInfoDto stb = new StockPoolBasicInfoDto();
        stb.stockPoolCode = 125L;
        stb.stockPoolName = "深发展";
        Gson gson = new Gson();
        List<StockPoolBasicInfoDto> strings = new ArrayList<StockPoolBasicInfoDto>();
        strings.add(stb);
        strings.add(stb);
        Integer a[] =  {1,2,3,4,5};
